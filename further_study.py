...
def custom_insert(input_list, index, value):
    ...
    """
    first=input_list[0:index]
    second=[value]
    third=input_list[index:]
...
def custom_remove(input_list, value):
    ...
    """
    first= input_list[0:input_list.index(value)]
    second= input_list[input_list.index(value)+1::]
...
def custom_pop(input_list):
    ...
    custom_remove(input_list,last_value)
    return last_value
...
def custom_contains(input_list, value):
    ...
    for item in input_list:
            if value==item:
                ...
                count_not_in_list+=1
                if count_not_in_list == len(input_list):
                    return False
